...
class AppLayout(ft.Row):
    def __init__(self, page: ft.Page, config_manager: ConfigManager):
        ...
        self.content_container = ft.Container(content=self.servers_view, expand=True)
        
        self.main_content_area = ft.Column([
            ft.Container(content=self.top_header, padding=ft.padding.only(left=20, right=20, top=10)),
            ft.Container(content=self.content_container, expand=True, padding=ft.padding.only(left=20, right=20, top=10, bottom=20))
